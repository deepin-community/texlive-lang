...
%*************************************************************************
%  Again the chosen values for \oddsidemargin, \topmargin and \evenside- *
%  margin are appropriate for a4 paper format. If your printer uses a    *
%  different papersize, e.g. letter format, adjust this values to those  *
