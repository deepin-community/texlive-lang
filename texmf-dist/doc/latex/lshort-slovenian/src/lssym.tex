...
\section{Seznam matematičnih simbolov}  \label{symbols}
 
Naslednje tabele prikazujejo vse simbole, ki so 
normalno na voljo v \emph{matematičnem načinu}.  

%
% Conditional Text in case the AMS Fonts are installed
%
Za uporabo simbolov iz tabel
~\ref{AMSD}--\ref{AMSNBR},\footnote{Te tabele so dobljene iz datoteke 
  \texttt{symbols.tex}, ki jo je napisal David~Carlisle, potem pa popravil še Josef~Tkadlec.} 
  morate v preambuli naložiti paket
\pai{amssymb}, na vašem sistemu pa morajo biti nameščene AMS  pisave. Če tega nimate,
poglejte na 
\CTANref|macros/latex/required/amslatex|. Še
popolnejši seznam vseh simbolov lahko najdete na
\CTANref|info/symbols/comprehensive|.

\begin{table}[!h]
\caption{Matematični akcenti.}  \label{mathacc}
\begin{symbols}{*3{cl}}
...
\begin{table}[!tbp]
\caption{Binarne relacije.}
\bigskip
Ustrezne negacije dobimo, če pred relacijo dodamo ukaz \verb|\not|.
\begin{symbols}{*3{cl}}
 \X{<}           & \X{>}           & \X{=}          \\
 ...
 \X{:}           & \X{\notin}      & \X{\neq}or \verb|\ne|
\end{symbols}
\centerline{\footnotesize $^a$Za ta simbol potrebujete paket \textsf{latexsym}}
\end{table}

\begin{table}[!tbp]
\caption{Binarne operacije}
\begin{symbols}{*3{cl}}
 \X{+}              & \X{-}              & &                 \\
...
\begin{table}[!tbp]
\caption{Oklepaji.}\label{tab:delimiters}
\begin{symbols}{*3{cl}}
 \X{(}            & \X{)}            & \X{\uparrow} \\
...
\begin{table}[!tbp]
\caption{AMS oklepaji.}\label{AMSD}
\bigskip
\begin{symbols}{*4{cl}}
...
\begin{table}[!tbp]
\caption{AMS grške in hebrejske črke.}
\begin{symbols}{*5{cl}}
...
\begin{table}[!tbp]
\caption{AMS negirane binarne relacije in puščice.}\label{AMSNBR}
\begin{symbols}{*3{cl}}
 \X{\nless}           & \X{\ngtr}            & \X{\varsubsetneqq}  \\
...
\begin{table}[!tbp]
\caption{Matematična abeceda.}
\begin{symbols}{@{}*3l@{}}
Primer& Ukaz &Potreben paket\\
\hline
...
$\mathfrak{ABCDE abcde 1234}$
        ...
        &\pai{amsfonts}  ali \textsf{amssymb}  \\
