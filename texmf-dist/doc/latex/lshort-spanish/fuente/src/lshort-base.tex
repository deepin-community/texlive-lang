...
\ifthenelse{\lengthtest{\paperwidth=8.5in}}
  {\def\computernomo{computador}\def\filenomo{archivo}\def\Filenomo{Archivo}
   \def\fontnomo{fuente}\def\fontsnomo{fuentes}\def\Fontsnomo{Fuentes}
   }
  {\def\computernomo{ordenador}\def\filenomo{fichero}\def\Filenomo{Fichero}
   \def\fontnomo{fundici\'on}\def\fontsnomo{fundiciones}\def\Fontsnomo{Fundiciones}
 }

\usepackage{lshort}
\usepackage{makeidx,shortvrb,latexsym}

% carleos aldonis je 2150611:
%\usepackage{indentfirst}
% rivera malaldonis 2014-W33-2
%
