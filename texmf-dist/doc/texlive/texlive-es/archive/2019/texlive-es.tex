...
\begin{description}
  ...
  \begin{ttdescription}
    \item[2018] Una versión anterior.
    \item[2019] La versión actual
    \begin{ttdescription}
      \item [bin] ~
      \begin{ttdescription}
  ...
  \item[directorio de casa del usuario] (\texttt{\$HOME} o el
      \texttt{\%USERPROFILE\%})
    \begin{ttdescription}
      \item[.texlive2018] Datos privados generados de configuración para la versión anterior.
      \item[.texlive2019] Datos privados generados de configuración para la versión actual.
      \begin{ttdescription}
...
\dirname{TEXDIR} es \dirname{/usr/local/texlive/2019} en los sistemas
Unix y |%SystemDrive%\texlive\2019| en Windows.  Acomodándolo de esta manera,
...
para el programa \prog{tlmgr}. Figura~\ref{fig:tlshell}
muestra \cmdname{tlshell}, el cual es escrito en Tcl/Tk y
trabaja inmediatamente tanto en Windows como en \MacOSX.
Figura~\ref{fig:tlcockpit} muestra \prog{tlcockpit}, el cual
...
\file{.../2019/texmf.cnf}. Si tienes que hacer modificaciones o
...
\file{.../2019/texmf-dist/web2c/texmf.cnf}.  Usted no debe editar este
...
\item El equipo de \acro{CTAN}, (\url{http://ctan.org}) que
...
\item Mojca Miklavec, por muchísima ayuda con \ConTeXt, edificando
    muchos conjuntos de binarios y mucho más.
