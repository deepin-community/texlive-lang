...
\filename{intall-tl}.
	...
	vez dada la opción \code{-gui} (estándar en Windows y \MacOSX
	más antiguos), o un modo de texto mediante \code{-gui=text}
...
\begin{description}
  ...
  \begin{ttdescription}
    \item[2021] Una versión anterior.
    \item[2022] La versión actual
    \begin{ttdescription}
      \item [bin] ~
      \begin{ttdescription}
  ...
  \item[directorio de casa del usuario] (\texttt{\$HOME} o el
      \texttt{\%USERPROFILE\%})
    \begin{ttdescription}
      \item[.texlive2021] Datos privados generados de configuración para la versión anterior.
      \item[.texlive2022] Datos privados generados de configuración para la versión actual.
      \begin{ttdescription}
...
\caption{\figdesc. Presionando el botón de Instalar te dará la
ventana como aparece en la figura ~\ref{fig:basic-w32} }\label{fig:nsis}
\end{figure}
...
\dirname{TEXDIR} es \dirname{/usr/local/texlive/2022} en los sistemas
Unix y |%SystemDrive%\texlive\2022| en Windows.  Acomodándolo de esta manera,
...
(típicamente) a \filename{~/.fonts.conf}, donde \filename{~} es el directorio de la casa. 
...
\file{.../2022/texmf.cnf}. Si tienes que hacer modificaciones o
